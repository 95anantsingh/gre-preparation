...
mindmap
  root((<font color=white>**Quantity, Size, </br>Degree & Comparisons**</font>))
    {{_Abundance & Excess_}}
      (_Plentiful_)
        **copious**
        **replete**
...
mindmap
  root((<font color=white>**Abundance & Excess**</font>))
    {{_Plentiful_}}
      **copious**
      ...
      **rife**
        (_Happening frequently_)
    {{_Excess_}}
      **inordinate**
        (_Excessive, not within limits_)
      **exorbitant**
        (_Excessive (price)_)
      **superfluous**
        (_Unnecessary, extra_)
...
mindmap
  root((<font color=white>**Scarcity & Smallness**</font>))
    {{_Insufficient_}}
      **scant**
        (_Barely enough_)
      **paucity**
    ...
    {{_Unimportant_}}
      ...
      **trifling**
        (_Trivial, not important_)
      **slight**
        (_Small, not important_)
      **inconsequential**
        (_Insignificant_)
      **pedestrian**
        (_Ordinary, dull_)
...
mindmap
  root((<font color=white>**Size & Scale**</font>))
    {{_Large_}}
      **prodigious**
        (_Extraordinarily large_)
      **palatial**
        (_Suitable for palace_)
      **ponderous**
        (_Heavy, bulky_)
      **monolithic**
        (_Massive, uniform_)
...
mindmap
  root((<font color=white>**Comparisons & Relations**</font>))
    {{_Equivalence_}}
      **commensurate**
        (_Proportional_)
      **complementary**
...
mindmap
  root((<font color=white>**Description & Qualification**</font>))
    {{_Modifiers_}}
      **albeit**
        (_Although_)
      **whereas**
    ...
    {{_Describing Degree_}}
      ...
      **latent**
        (_Potential, hidden_)
      **ostensible**
        (_Apparent, pretended_)
      **implicit**
        (_Implied_)
      **virtual**
        (_Existing in essence_)
      **derivative**
        (_Not original_)
```
