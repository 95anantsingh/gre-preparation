...
mindmap
  root((<font color=white>**Judgment, Bias & </br>Decision-Making**</font>))
    {{_Fairness & Objectivity_}}
      (_Unbiased_)
        **impartial**
        **disinterested**
        **dispassionate**
...
mindmap
  root((<font color=white>**Fairness & Objectivity**</font>))
    {{_Unbiased_}}
      **impartial**
        (_Unbiased, fair_)
      **disinterested**
      ...
      **dispassionate**
        (_Unbiased, calm_)
      **objective**
        (_Factual, not emotional_)
      **detached**
        (_Impartial, disinterested_)
      **equitable**
        (_Fair, equal, just_)
    {{_Standards_}}
      **canonical**
        (_Authorized, recognized_)
      **paradigm**
        (_Model or pattern_)
      **normative**
        (_Establishing a norm_)
      **benchmark**
...
mindmap
  root((<font color=white>**Bias & Partiality**</font>))
    {{_Prejudiced_}}
      **partial**
        (_Biased, favoring one_)
      **partisan**
        (_Devoted to a group_)
      **tendentious**
        (_Biased, promoting a view_)
      **subjective**
        (_Based on personal feelings_)
      **chauvinism**
        (_Undue devotion to group_)
    {{_Narrow-Minded_}}
      **insular**
        (_Narrow-minded, provincial_)
      **illiberality**
        (_Narrow-mindedness_)
      **doctrinaire**
        (_Applying doctrine rigidly_)
      **myopic**
        (_Near-sighted, short-term_)
      **provincial**
...
mindmap
  root((<font color=white>**Deciding & Choosing**</font>))
    {{_Making Decisions_}}
      **deem**
        (_Judge, consider_)
      **arbiter**
      ...
      **judicious**
        (_Using good judgment_)
      **resolve**
        (_Find solution, decide_)
      **clinch**
        (_Make final, settle_)
    {{_Hesitating_}}
      **vacillate**
      ...
      **irresolute**
        (_Wavering, not firm_)
      **quandary**
        (_Uncertainty, dilemma_)
      **dither**
        (_Act indecisively_)
      **impasse**
        (_Deadlock, no escape_)
    {{_Assumptions_}}
      **presumptive**
        (_Based on assumption_)
      **supposition**
        (_Assumption, hypothesis_)
      **posit**
        (_Presume, suggest_)
      **surmise**
        (_Guess, infer_)
...
mindmap
  root((<font color=white>**Moral Judgment**</font>))
    {{_Virtue_}}
      **principled**
        (_High moral standards_)
      **probity**
        (_Honesty, integrity_)
      **sacrosanct**
        (_Sacred, inviolable_)
    ...
    {{_Vice_}}
      **iniquity**
        (_Injustice, wickedness_)
      **turpitude**
        (_Depravity, baseness_)
      **unconscionable**
        (_Not guided by conscience_)
      **peccadillo**
        (_Small sin or fault_)
      **transgression**
        (_Violation of law_)
    {{_Reputation_}}
      **credibility**
        (_Believability, trust_)
      **notoriety**
        (_Ill fame_)
      **standing**
        (_Status, rank_)
...
mindmap
  root((<font color=white>**Evaluation**</font>))
    {{_Assessing_}}
      **qualified**
        (_Modified, limited_)
      **warranted**
        (_Justified, authorized_)
      **commensurate**
        (_Proportional_)
      **nominal**
        (_Trivial, in name only_)
      **nontrivial**
        (_Important_)
    {{_Accepting_}}
      **condone**
        (_Overlook, tolerate_)
      **countenance**
        (_Approve or tolerate_)
      **brook**
        (_Suffer or tolerate_)
    {{_Rejecting_}}
      **dismiss**
        (_Put aside, reject_)
      **table**
        (_Lay aside for later_)
      **forestall**
        (_Delay, prevent_)
```
...
mindmap
  root((<font color=white>**Roots**</font>))
      ...
      **verify**
        (_make true_)
    )**prob**</br>_prove/good_(
      **probity**
        (_integrity_)
      **approbation**
        (_approval_)
    )**sacr/sanct**</br>_holy_(
      **sacrosanct**
        (_very holy_)
      **sanction**
        (_approve/holy law_)
