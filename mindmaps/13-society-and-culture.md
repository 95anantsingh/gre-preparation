...
mindmap
  root((<font color=white>**Society & Culture**</font>))
    {{_Groups & Belonging_}}
      (_Social Groups_)
        **coterie**
        **faction**
...
mindmap
  root((<font color=white>**Groups & Belonging**</font>))
    {{_Social Groups_}}
      **coterie**
        (_Close or exclusive group_)
      **faction**
        (_Group within larger organization_)
      **phalanx**
        (_Close group for defense_)
      **bevy**
        (_Large group_)
      **ranks**
        (_Personnel, group of people_)
    {{_Social Identity_}}
      **solidarity**
        (_Fellowship in interests_)
      **cosmopolitan**
        (_At home globally_)
      **endemic**
        (_Native, local_)
      **insular**
        (_Detached, narrow-minded_)
      **xenophobia**
        (_Fear of foreigners_)
    {{_Outcasts_}}
      **pariah**
        (_Social outcast_)
      **recluse**
        (_Person who lives in seclusion_)
      **hermetic**
        (_Isolated, reclusive_)
      **alienate**
        (_Cause to become unfriendly_)
```
...
mindmap
  root((<font color=white>**Customs & Norms**</font>))
    {{_Social Rules_}}
      **mores**
        (_Customs, manners, morals_)
      **propriety**
        (_Conforming to good manners_)
      **decorous**
        (_Behaving with propriety_)
      **ethos**
        (_Character or moral values_)
      **status quo**
        (_Existing state_)
    {{_Breaking Norms_}}
      **solecism**
        (_Etiquette mistake_)
      **unseemly**
        (_Improper, inappropriate_)
      **gauche**
        (_Tactless, lacking grace_)
      **aberrant**
        (_Abnormal, deviant_)
      **anomaly**
        (_Deviation from common_)
    {{_Traditions_}}
      **orthodox**
        (_Adhering to tradition_)
      **archaic**
        (_Ancient, old-fashioned_)
      **bygone**
        (_Past, former_)
      **anachronism**
        (_Out of correct time_)
      **hoary**
        (_Very old, gray_)
```
...
mindmap
  root((<font color=white>**Diversity & Variety**</font>))
    {{_Mixed_}}
      **heterogeneous**
        (_Different in type_)
      **eclectic**
        (_Selecting from many sources_)
      **multifarious**
        (_Diverse, varied_)
      **variegated**
        (_Varied in color_)
...
mindmap
  root((<font color=white>**Social Class**</font>))
    {{_Elite_}}
      **rarefied**
        (_Lofty, exclusive_)
      **echelon**
      ...
      **august**
        (_Venerable, majestic_)
    {{_Common_}}
      **plebian**
        (_Of the common people_)
      **rustic**
        (_Relating to country life_)
      **bucolic**
...
mindmap
  root((<font color=white>**Communication</br>in Society**</font>))
    {{_Public Opinion_}}
      **clamor**
        (_Noisy uproar_)
      **polemic**
        (_Controversial argument_)
      **polarized**
        (_Divided into opposed groups_)
      **tendentious**
        (_Biased_)
    {{_Conformity_}}
      **compliant**
      ...
      **complacent**
        (_Self-satisfied, smug_)
      **orthodox**
        (_Adhering to customs_)
    {{_Dissent_}}
      **maverick**
...
mindmap
  root((<font color=white>**Roots**</font>))
      ...
      **gregarious**
        (_sociable_)
      **segregate**
        (_separate from flock_)
    )**eth**</br>_character_(
      **ethos**
        (_character of group_)
      **ethics**
        (_moral character_)
    )**cosm**</br>_world_(
      **cosmopolitan**
