...
mindmap
  root((<font color=white>**Actions & </br>Behaviors**</font>))
    {{_Aggressive Actions_}}
      (_Attack_)
        **assail**
        **besiege**
        **brandish**
...
mindmap
  root((<font color=white>**Aggressive Actions**</font>))
    {{_Attack_}}
      **assail**
        (_Attack violently_)
      **besiege**
...
mindmap
  root((<font color=white>**Gentle Actions**</font>))
    {{_Caring_}}
      **cosset**
        (_Pamper, treat as pet_)
      **anoint**
        (_Rub oil on_)
      **burnish**
        (_Polish_)
...
mindmap
  root((<font color=white>**Strategic Actions**</font>))
    {{_Planning_}}
      **forestall**
        (_Prevent by acting first_)
      **pre-empt**
        (_Take before others_)
      **precipitate**
        (_Cause suddenly_)
      **hedge**
        (_Avoid commitment_)
...
| **disperse**    | Scatter                                                                                                                  |                                                                   | The police used tear gas to **disperse** the crowd.                     |
...
mindmap
  root((<font color=white>**Corrective Actions**</font>))
    {{_Fixing_}}
      **redress**
        (_Set right_)
      **remedial**
...
mindmap
  root((<font color=white>**Yielding Actions**</font>))
    {{_Surrendering_}}
      **concede**
        (_Give in, admit_)
      **abdicate**
...
mindmap
  root((<font color=white>**Social Behaviors**</font>))
    {{_Imitating_}}
      **emulate**
        (_Copy to equal_)
      **ape**
...
| **searchingly** | Examining closely                                                                                   |                                                             | He looked at me **searchingly**.                            |
| **sound**       | Measure depth                                                                                       |                                                             | They **sound** the depths of the ocean.                     |
